...
tag:
  ...
  - 3.x版本升级日志
---
## 3.11.0-java17 2023年09月25日21:21:00
### build
...
## 3.10.0-java17 2023年08月03日11:08:32
### build
- spring-cloud-dependencies.version>2022.0.3
...
### fix
- (lamp-core): EnumDeserializer 适配新版本
- (lamp-oauth-server): 修改获取IP的方法，便于获取本地iP
- connectType数据修改为{SYSTEM:系统;CUSTOM:自定义}
...
## 2.5.1 升级日志 （2020年09月05日16:48:42）
- 升级依赖
```
