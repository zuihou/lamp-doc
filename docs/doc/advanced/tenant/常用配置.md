...
- 修改SQL脚本
  ...
  - `lamp-tenant-datasource-init/src/main/resources/schema/{数据库类型}/lamp_base.sql`  修改为 test_base.sql
  - `lamp-tenant-datasource-init/src/main/resources/data/{数据库类型}/lamp_base.sql `修改为 test_base.sql
...
- 添加SQL脚本
  ...
  - 在 `lamp-tenant-datasource-init/src/main/resources/schema/{数据库类型}/`  目录添加 test_extend.sql
  - 在 `lamp-tenant-datasource-init/src/main/resources/data/{数据库类型}/ ` 目录添加 test_xxx.sql
