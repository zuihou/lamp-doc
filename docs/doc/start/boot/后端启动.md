...
2. 启动: [BootServerApplication](http://git.tangyh.top/zuihou/lamp-datasource-max/blob/java17/5.x/lamp-support/lamp-boot-server/src/main/java/top/tangyh/lamp/BootServerApplication.java)
