  ...
  <Sidebar>
    <template #top>
      <div id="sidebar-slot-top" style="padding: 1rem 0;width:100%;margin:0 auto;display:flex;flex-direction: column;">
        <a style="margin: 0px auto; width: 100%;" href="https://www.jnpfsoft.com/index.html?from=tangyh" target="_blank">
        ...
        <div style="margin-top: 1.5rem; order: 9999;">
          ...
          <span style='color: #E01E5A;font-size: smaller;font-weight: bolder;float: right'>❤️<a href='/vip/广告位'>成为赞助商</a></span>
        </div>
