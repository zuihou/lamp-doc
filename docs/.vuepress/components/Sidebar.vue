  ...
  <Sidebar>
    <template #top>
      <div id="sidebar-slot-top" style="padding: 1rem 0;width:100%;margin:0 auto;display:flex;flex-direction: column;">
        <a style="margin: 0px auto; width: 100%;" href="http://mddata.top/?from=lamp" target="_blank" data-date="2026-04-03">
          <img className="no-zoom" height="60" style="width: 100%;" src="/images/adv/mdp-adv3.png">
        </a>
