...
## 企业版或个人版交付物
- 源码：开通私服gitlab账号，自己更新代码
- 3.x 离线文档：PDF格式，文档内容跟 [在线文档](https://www.kancloud.cn/zuihou/zuihou-admin-cloud) 一致
- 4.x 在线文档
...
2. **不提供免费微信技术支持**，若你习惯当伸手党，遇到问题希望别人快速帮你解决且不愿意通过 issues 的方式获取帮助，建议购买 "问题快速解答群"。

3. 作者非常乐意免费的回复 issues 和 discussions 中的问题，但拒绝回复微信群中的报错类问题。遇到问题、bug可以在提 [issues](https://github.com/dromara/lamp-cloud/issues) 咨询。
